                            ...
                            >
                              ...
                              <b-dropdown-item-button class="">
                                <button
                                  ...
                                  @click.prevent="
                                    deleteExperience(item.id_experience)
                                  "
                                >
                          ...
                          <b-col lg="6" class="text-left">
                            <div class="form-group">
                              ...
                              <input
                                ...
                                v-model="item.id_company_exp"
                                :id_company_exp="item.id_company_exp"
                              />
                            </div>
                          </b-col>
                          <b-col lg="6">
                      ...
                      <b-col lg="12">
                        <div class="form-group">
                          ...
                          <textarea
                            ...
                            v-model="item.description_exp"
                            :description_exp="item.description_exp"
                          ></textarea>
                        </div>
                        <!-- </form> -->
                      </b-col>
